...
export default function ImprovedHeader() {
  ...
  // Ensure header is always visible by adding a semi-transparent background
  const headerBg = isScrolled ? "bg-white shadow-md" : "bg-gradient-to-b from-black/30 to-transparent backdrop-blur-sm"
